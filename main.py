...
def main():
  ...
  #  stageMapData  = stageMapTab.get_all_records()
    ...
    finalContentFilePath = os.path.join(os.path.dirname(__file__), "merged_lead_bank_data.csv")
    if not os.path.isfile(finalContentFilePath):
        ...
        mergedDF.to_csv(finalContentFilePath, index=False, encoding="utf-8")
        data_to_save = mergedDF
    else:
        print("file found")
